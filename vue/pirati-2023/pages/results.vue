<template>
  <div class="page container">
    ...
    <hr/>
    <div class=" p-4 m-4 alert alert-light">
        💬 FEEDBACK - Zajímá nás váš názor: <a href="https://ankety.pirati.cz/index.php/299361?lang=cs" target="_blank" class="alert-link">Napište autorům kalkulačky!</a>
      </div>
    <hr/>
...
export default {
  ...
  head: function() {
    return {
      title: '🏴‍☠️ Piráti EP 2023 - výsledky',
      meta: [
        {
          hid: 'results',
          name: 'Výsledky volební kalkulačky',
          description: '🏴‍☠️ Piráti EP 2023 - výsledky'
        }
      ]
    }
  },
